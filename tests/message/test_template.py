...
def test_send_generic_template():
    ...
    args = {
        ...
        'elements': [
            {
                'title': 'Title',
                'image_url': 'https://labpositiva.com/image1.png',
                'subtitle': 'subtitle.',
                'default_action': {
                    'type': 'web_url',
                    'url': 'https://labpositiva.com/item/103',
                    'messenger_extensions': True,
                    'webview_height_ratio': 'tall',
                    'fallback_url': 'https://labpositiva.com/',
                },
                'buttons': [
                    {
                        'type': 'web_url',
...
def test_send_generic_template_multiple():
    ...
    args = {
        ...
        'elements': [
            ...
            {
                'title': 'Title2',
                'image_url': 'https://labpositiva.com/image2.png',
                'subtitle': 'subtitle.',
                'buttons': [
                    {
                        'type': 'postback',
